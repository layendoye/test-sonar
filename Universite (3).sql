...
-- Généré le :  Lun 01 Juillet 2019 à 09:10
...
(30, 'Diop', 'Momar', '2019-07-01', 'mom@gmail.com', 774563214);
...
--
ALTER TABLE `Batiment`
  MODIFY `id_Batiment` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
--
...
--
ALTER TABLE `Non_Boursiers`
  MODIFY `id_Non_Boursiers` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
